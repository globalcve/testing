    ...
    <div className="min-h-screen bg-[#282a36] text-[#f8f8f2]">
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        {!loading && cves.length > 0 && (
          <div className="mb-6 p-4 bg-[#ffb86c]/20 border border-[#ffb86c] text-[#ffb86c] rounded-lg text-sm">
            ℹ️ Showing {cves.length} CVEs from KEV, JVN, and NVD sources. Other sources require search queries (use home page search).
          </div>
        )}
